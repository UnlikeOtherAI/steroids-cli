...
- **Specification location:** `docs/cli/specs/global-runner-registry.md`

#### What Coder Did
- **Rejection #1-7:** Modified `src/orchestrator/reviewer.ts` and `src/prompts/reviewer.ts` (completely wrong files)
- **Rejection #8-10:** Added documentation files (`docs/project/REVIEWER-CONTEXT.md`, `docs/cli/specs/reporting-improvements.md`)
...
docs/project/REVIEWER-CONTEXT.md and docs/cli/specs/reporting-improvements.md; there are no changes
