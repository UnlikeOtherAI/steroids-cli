...
import type { RejectionEntry } from '../database/queries.js';

export function formatReviewerCustomInstructions(customInstructions?: string): string {
...
export function formatRejectionHistory(rejections?: RejectionEntry[]): string {
...
export function formatCoordinatorGuidance(guidance?: string, decision?: string): string {
  if (!guidance) return '';
...
export function getTestCoverageInstructions(config: SteroidsConfig, modifiedFiles?: string[]): string {
...
export function buildReviewerSecuritySection(): string {
...
export function buildReviewerDecisionSection(nextRejectionNumber: number): string {
...
This will be rejection #${nextRejectionNumber}.
