/**
 * Template Parser Tests — Core functionality
 *
 * Tests for parseTemplate, parseTemplateObject, resolveEnvVars,
 * basic resolveVariable, validateTemplate, and getAvailableVariables.
 */
